...
def stepwiseAnalysis(snakemake=None):
    ...
    filtered_count_df_des.to_csv(out_folder+"/filterd_count_matrix_pool5_2.txt",sep='\t')
    ...
    geneConv,old_to_new_ids,geneConv_new=getNewIdfromPrevID(filtered_count_df.index,prev_to_new,db_df)
    plot_info={'pool':'pool5_2','file':out_folder+'/pool5_2_repeat.xlsx','rel_file':out_folder+'/pool5_2_propagated_error_relative_abundance.pdf','d':['d0','d13'],
