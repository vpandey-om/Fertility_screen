...
mpmp_data=pickle.load(open(snakemake.input[0],'rb'))
...
mpmp_remove=pd.read_excel(snakemake.input[1],sheet_name='rCS',header=None)
...
male_df=pd.read_csv(snakemake.input[2],sep='\t')
female_df=pd.read_csv(snakemake.input[3],sep='\t')
...
fertility_screen=pd.read_excel(snakemake.input[4],sheet_name='data')
