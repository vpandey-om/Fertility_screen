...
def stepwiseAnalysis():
    ...
    manifests_df=pd.read_csv(data_folder+"/manifest_metabolic_pool1.txt",sep='\t')
    count_df=pd.read_csv(data_folder+ "/barcode_counts_table_050221_metabolic_pool.txt",sep='\t')
    input_df=pd.read_csv(data_folder+'/input_metabolic_pool1.txt', sep='\t')
    ...
    filtered_count_df_des.to_csv(out_folder+"/filterd_count_matrix_metabolic_pool1.txt",sep='\t')
    ...
    plot_info={'pool':'metabolic_pool1','rel_file':out_folder+'/metabolic_pool1_propagated_error_relative_abundance.pdf','d':['d0','d14'],
    'mf':['mf1','mf2'],'N':['LN','HN'],'geneConv':geneConv_new,
    'control_genes':['PBANKA_0101100' , 'PBANKA_0707000','PBANKA_0932900','PBANKA_1024600','PBANKA_0517700'],'rgr_file':out_folder+'/metabolic_pool_RGR.xlsx'}
    relative_growth_rate_analysis_arjun(filtered_count_df,manfest_df,prev_to_new,db_df,plot_info)
