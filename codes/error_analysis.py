...
pilot=read_pickle_file(snakemake.input[0])
pool1=read_pickle_file(snakemake.input[1])
pool2=read_pickle_file(snakemake.input[2])
pool3=read_pickle_file(snakemake.input[3])
pool4=read_pickle_file(snakemake.input[4])
pool6=read_pickle_file(snakemake.input[5])
pool5_1=read_pickle_file(snakemake.input[6])
pool7_1=read_pickle_file(snakemake.input[7])
pool5_2=read_pickle_file(snakemake.input[8])
pool7_2=read_pickle_file(snakemake.input[8])
